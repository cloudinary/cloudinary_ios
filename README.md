...
You can download Alamofire v4.1.0 from [here](https://github.com/Alamofire/Alamofire/archive/4.1.0.zip). Then follow the instruction in [Add library](#add_library)
