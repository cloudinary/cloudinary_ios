...
class PreprocessTests: BaseTestCase {
    ...
    func test_rotate_shouldEqualPrePreparedImage() {
        ...
        // Then
        XCTAssertEqual(sut.jpegData(compressionQuality: 0.1), prePreparedImage.jpegData(compressionQuality: 0.1), "rotated image should be equal to pre prepared image")
    }
